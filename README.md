...
This project was developed using Python 3.11.4. To create a Python environment you first need to have the correct Python version installed, you can then run the following command:
```bash
